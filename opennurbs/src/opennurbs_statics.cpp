...
const ON_SHA1_Hash ON_SHA1_Hash::ZeroDigest = ON_SHA1_Hash();//ON_CLANG_CONSTRUCTOR_BUG_INIT(ON_SHA1_Hash);

const ONX_ModelTest ONX_ModelTest::Unset = ONX_ModelTest();//ON_CLANG_CONSTRUCTOR_BUG_INIT(ONX_ModelTest);
...
const ON_AngleValue ON_AngleValue::Unset = ON_AngleValue();//ON_CLANG_CONSTRUCTOR_BUG_INIT(ON_AngleValue);
